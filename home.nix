...
-- UNBIND default terminal shortcuts to prevent double-spawning
hl.unbind(mainMod .. "+RETURN")
hl.unbind(mainMod .. "+Return")

-- BIND SUPER+RETURN to Kitty only
...
confirm_os_window_close = 0;
  ...
  # Ensure Kitty config is strictly controlled by Home Manager
...
programs.zsh = {
    ...
    initContent = ''
      # Load dynamic color sequences generated by illogical-impulse (matugen / wal)
      ...
      # Style autosuggestions with bold dimmed text
